-- lucigui - Auto Play Piano Script para Roblox
-- Versão traduzida para português com design melhorado
-- Script principal executável
-- 
-- Este script contém:
-- - GUI completa com categorias de músicas
-- - Sistema de busca
-- - Favoritos
-- - Músicas customizadas
-- - Controles de reprodução

-- Execute este arquivo diretamente no executor do Roblox
...
frame.BackgroundColor3 = Color3.fromRGB(25, 25, 35)
    ...
    title.Name = "title"
    title.Parent = frame
    title.BackgroundColor3 = Color3.fromRGB(70, 80, 100)
    ...
    searchframe.Size = UDim2.new(0, 208, 0, 38)
        ...
        searchbar.BackgroundColor3 = Color3.fromRGB(50, 60, 80)
    ...
    bar.ZIndex = 0
        ...
        songname.Parent = bar
        songname.BackgroundColor3 = Color3.fromRGB(70, 80, 100)
        songname.BorderColor3 = Color3.fromRGB(50, 60, 80)
        songname.BorderSizePixel = 0
        local songnameCorner = Instance.new("UICorner")
        songnameCorner.CornerRadius = UDim.new(0, 6)
        songnameCorner.Parent = songname
        ...
        bpmbox.Name = "bpmbox"
        bpmbox.Parent = bar
        bpmbox.BackgroundColor3 = Color3.fromRGB(50, 60, 80)
        bpmbox.BorderColor3 = Color3.fromRGB(0, 0, 0)
        bpmbox.BorderSizePixel = 0
        local bpmboxCorner = Instance.new("UICorner")
        bpmboxCorner.CornerRadius = UDim.new(0, 4)
        bpmboxCorner.Parent = bpmbox
        ...
        playsong.Parent = bar
        playsong.BackgroundColor3 = Color3.fromRGB(70, 80, 100)
        playsong.BorderColor3 = Color3.fromRGB(50, 60, 80)
        playsong.BorderSizePixel = 0
        local playsongCorner = Instance.new("UICorner")
        playsongCorner.CornerRadius = UDim.new(0, 6)
        playsongCorner.Parent = playsong
...
toggle.BackgroundColor3 = Color3.fromRGB(60, 70, 90)
toggle.BorderColor3 = Color3.fromRGB(80, 90, 110)
...
toggle.Size = UDim2.new(0, 140, 0, 42)
...
local function newSongButton(name, alternateNames)
    ...
    button.BorderColor3 = Color3.fromRGB(50, 60, 80)
...
customnotice.BackgroundColor3 = Color3.fromRGB(70, 80, 100)
customnotice.BorderColor3 = Color3.fromRGB(50, 60, 80)
customnotice.BorderSizePixel = 0
local customnoticeCorner = Instance.new("UICorner")
customnoticeCorner.CornerRadius = UDim.new(0, 6)
customnoticeCorner.Parent = customnotice
...
local function newcategory(name)
    ...
    TextButton.BackgroundColor3 = Color3.fromRGB(70, 80, 100)
    TextButton.BorderColor3 = Color3.fromRGB(50, 60, 80)
    TextButton.BorderSizePixel = 0
    local categoryCorner = Instance.new("UICorner")
    categoryCorner.CornerRadius = UDim.new(0, 5)
    categoryCorner.Parent = TextButton
...
local function newCustomSongButton(name)
    ...
    customsongframe.BackgroundColor3 = Color3.fromRGB(70, 80, 100)
    customsongframe.BorderColor3 = Color3.fromRGB(50, 60, 80)
    customsongframe.BorderSizePixel = 0
    local customsongframeCorner = Instance.new("UICorner")
    customsongframeCorner.CornerRadius = UDim.new(0, 6)
    customsongframeCorner.Parent = customsongframe
...
Auto Play Piano Script para Roblox
Versão em Português

]])

print("lucigui carregado com sucesso!")
